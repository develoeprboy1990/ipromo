...
<div class="mb-1 row">
<label for="example-email-input" class="col-md-2 col-form-label fw-bold ">Phone Number</label>
<div class="col-md-4">
<input class="form-control" type="text"  value="{{old('Phone')}}"  name="Phone" id="example-email-input">
</div>
</div>
<div class="mb-1 row">
 ...
 -->
  <div class="row">
     ...
     <td  >{{$no++}}</td>
        ...
        <a href="#"  onclick="delete_confirm2('CustomerDelete',{{$value->CustomerID}});" class="text-secondary"><i class="mdi mdi-delete font-size-15"></i></a>
